<script setup>
    ...
    import { Breadcrumb,Dialog,FileUpload, DataTable,Column,Button,InputText,IconField,InputIcon, Toast,Checkbox,Tag, RadioButton, Select, Textarea, Rating, InputNumber, Toolbar} from 'primevue'

    const breadcrumbHome = ref({ icon: 'pi pi-home', to: '/' });
    const breadcrumbItems = ref([{ label: 'Trang chủ' }, { label: 'Danh Sách', route: '/pages/tenant' }]);
